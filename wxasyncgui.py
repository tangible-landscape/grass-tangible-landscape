...
Modified to be able to run with asyncio

Classes:
 - wxgui::GMApp

(C) 2006-2020 by the GRASS Development Team
...
@author Anna Petrasova <kratochanna gmail.com> (asyncio)
"""
