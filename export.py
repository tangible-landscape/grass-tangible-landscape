...
class OutputPanel(wx.Panel):
    def __init__(self, parent, giface, settings):
        ...
        sizer.Add(
            wx.StaticText(self, label="Name of scanned raster:"),
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        sizer.Add(
            wx.StaticText(self, label="Name of calibration scan raster:"),
            flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL,
            border=5,
        )
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        sizer.Add(
            self.ifBlender, flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.LEFT, border=3
        )
        sizer.Add(
            self.blenderPath,
            flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL,
        ...
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        sizer.Add(
            self.ifPLY, flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.LEFT, border=3
        )
        sizer.Add(
            self.exportPLY,
            flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL,
    ...
    def _addLayer(self, ltype):
        ...
        if ltype == "scan":
            ...
            cmd = [
                "d.rgb",
                "red={m}".format(m=name + "_r"),
                "green={m}".format(m=name + "_g"),
                "blue={m}".format(m=name + "_b"),
                "-n",
            ]
