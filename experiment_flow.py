...
#                        depth='flow_flow_final', niterations=200, diffusion_coeff=1, hmax=0.15, halpha=8, env=env)
    ...
    diff_pos = gscript.parse_command('r.univar', map='flow_difference_positive', flags='g', env=env)['sum']
    diff_neg = gscript.parse_command('r.univar', map='flow_difference_negative', flags='g', env=env)['sum']
